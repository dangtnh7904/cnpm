...
create DATABASE QuanLyChungCuDB;
    ...
    -- Bảng Tạm trú (Refactored: Liên kết với NhanKhau thay vì HoGiaDinh)
    -- LOGIC NGHIỆP VỤ:
    ...
    CREATE TABLE TamTru (
        ...
        ID_NhanKhau INT NOT NULL,              -- Liên kết với NhanKhau (người tạm trú)
        MaGiayTamTru NVARCHAR(50) NULL,        -- Mã giấy tạm trú (nếu có - do cơ quan cấp)
    ...
    -- Bảng Tạm vắng (Người ở đây đi vắng tạm thời)
    -- LOGIC NGHIỆP VỤ:
    -- - Tạm vắng = Người ĐÃ LÀ THÀNH VIÊN của hộ đi vắng
    ...
    CREATE TABLE TamVang (
        ...
        NgayBatDau DATE NOT NULL,
        NgayKetThuc DATE NULL,                 -- Có thể null nếu chưa biết ngày về
        NoiDen NVARCHAR(255),
        LyDo NVARCHAR(500),
        NgayDangKy DATETIME DEFAULT GETDATE()
    );
    ...
    ALTER TABLE TamTru
    ADD CONSTRAINT FK_TamTru_NhanKhau
    FOREIGN KEY (ID_NhanKhau) REFERENCES NhanKhau(ID_NhanKhau) ON DELETE CASCADE;
